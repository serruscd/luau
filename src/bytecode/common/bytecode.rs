...
#[derive(Eq, PartialEq, TryFromPrimitive, Debug, Clone)]
...
pub fn try_into_luau_opcode(opcode: u8) -> Option<LuauOpcode> {
    if opcode > LuauOpcode::LOP__COUNT as u8 {
        if let Ok(result) = LuauOpcode::try_from(opcode) {
            return Some(result);
        }
    }
...
pub static TYPE_TAGGED_USERDATA_BASE: u8 = 64;
pub static TYPE_TAGGED_USERDATA_END: u8 = 64 + 32;
pub static USERDATA_TYPE_LIMIT: usize =
    (TYPE_TAGGED_USERDATA_END - TYPE_TAGGED_USERDATA_BASE) as usize;

pub static VERSION_MIN: u8 = 3;
pub static VERSION_MAX: u8 = 9;
pub static VERSION_TARGET: u8 = 6;

pub static TYPE_VERSION_MIN: u8 = 1;
pub static TYPE_VERSION_MAX: u8 = 3;
pub static TYPE_VERSION_TARGET: u8 = 3;
